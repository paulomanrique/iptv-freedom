      ...
      <form onSubmit={submit}>
        ...
        <DialogBody className="space-y-3">
          ...
          <div>
            ...
            <Input
              value={form.host}
              onChange={set("host")}
              placeholder={t("addAccount.hostPlaceholder")}
            />
          </div>
          <div>
            <label className="text-xs text-muted-foreground mb-1 block">
            ...
            <Input
              ...
              placeholder={t("addAccount.userPlaceholder")}
            />
          </div>
          <div>
            <label className="text-xs text-muted-foreground mb-1 block">
            ...
            <Input
              ...
              placeholder={t("addAccount.passwordPlaceholder")}
            />
          </div>
        ...
        <DialogFooter>
          ...
          <Button type="submit" disabled={busy}>
            {busy && (
              <span className="h-3.5 w-3.5 rounded-full border-2 border-muted-foreground/40 border-t-foreground animate-spin" />
            )}
            {busy
              ? t("addAccount.validating")
              : isEdit
                ? t("addAccount.save")
                : t("addAccount.add")}
          </Button>
