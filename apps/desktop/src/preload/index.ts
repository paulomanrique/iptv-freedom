...
const api: WindowApi = {
  ...
  accounts: {
    ...
    update: (id: string, account: AccountInput) => ipcRenderer.invoke('accounts:update', id, account),
  ...
  xtream: {
    ...
    categories: (account: Account, kind: Kind) => ipcRenderer.invoke('xtream:categories', account, kind),
